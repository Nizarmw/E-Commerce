...
const pages = ['Products', 'Categories', 'Deals'];
...
const Header = () => {
  ...
  const drawerItems = [
    ...
    { text: 'Deals', icon: <LocalShipping />, path: '/deals' },
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseUserMenu} component={RouterLink} to={`/${setting.toLowerCase()}`}>
